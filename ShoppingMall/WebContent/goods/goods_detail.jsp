...
<%
	...
	String[] arrImage = itemArray.getGOODS_IMAGE().split(",");
...
<table width="960" cellspacing="0" cellpadding="0" border="0"
	...
	<tr>
		...
		<tr>
			...
			<img src="/ShoppingMall/upload/<%=arrImage[0]%>" 
		...
		<tr>
			...
			<table align="center">
				<tr>
					...
					<div align="center">
						<img 
						src="/ShoppingMall/upload/<%=prevpage.getGOODS_IMAGE()%>"
					...
					%>
						<div align="center">
						<img
						src="/ShoppingMall/upload/<%=nextpage.getGOODS_IMAGE()%>"
						width="70" height="50" border="0">
		...
		<table width="200" border="0" align="center">
			<tr align="left">
				<td colspan="3"><c:forEach var="itemimg"
					...
					<img src="/ShoppingMall/upload/${fn:trim(itemimg)}" />
				</c:forEach></td>
			</tr>
		</table>
		<!-- 상품 내용 끝 --></td>
